...
- (void)createOrderTabView
{
    ...
    [self.orderTabView registerClass:[ZCListTableViewCell class] forCellReuseIdentifier:@"orderCell"];
...
- (void)buildSubScreenMenu
{
    ...
    [self.orderTypeTabView registerClass:[ZCMenuTableViewCell class] forCellReuseIdentifier:@"subScreen"];
    ...
    [self.orderTimeTabView registerClass:[ZCMenuTableViewCell class] forCellReuseIdentifier:@"subScreen"];
...
{
    if ([tableView isEqual:self.orderTabView]) {
        ZCListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"orderCell" forIndexPath:indexPath];
        ...
        if ([tableView isEqual:self.orderTypeTabView]){
            ZCMenuTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"subScreen" forIndexPath:indexPath];
            // 订单类型 开始默认选中的菜单项
